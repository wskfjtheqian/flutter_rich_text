...
///    more detail.
enum RichTextSelectionHandleType {
...
typedef RichDragSelectionUpdateCallback = void Function(DragStartDetails startDetails, DragUpdateDetails updateDetails);
...
typedef RichToolbarBuilder = Widget Function(BuildContext context, Widget child);
...
class RichToolbarItemsParentData extends ContainerBoxParentData<RenderBox> {
...
abstract class RichTextSelectionControls {
  ...
  /// selection position.
  Widget buildHandle(BuildContext context, RichTextSelectionHandleType type, double textLineHeight);
  ...
  Offset getHandleAnchor(RichTextSelectionHandleType type, double textLineHeight);
  ...
  Widget buildToolbar(
    ...
    Offset position,
    List<RichTextSelectionPoint> endpoints,
    TextSelectionDelegate delegate,
    RichClipboardStatusNotifier clipboardStatus,
  ...
  /// the user.
  void handleCopy(TextSelectionDelegate delegate, RichClipboardStatusNotifier? clipboardStatus) {
    final TextEditingValue value = delegate.textEditingValue;
    Clipboard.setData(ClipboardData(
      text: value.selection.textInside(value.text),
    ));
...
class RichTextSelectionOverlay {
  ...
  final RichClipboardStatusNotifier? clipboardStatus;
  ...
  Widget _buildToolbar(BuildContext context) {
    ...
    final List<RichTextSelectionPoint> endpoints = renderObject.getEndpointsForSelection(_selection);
...
class _TextSelectionHandleOverlayState extends State<_TextSelectionHandleOverlay> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final RichTextSelectionHandleType type;
    ...
    switch (widget.position) {
      case _TextSelectionHandlePosition.start:
        ...
        type = _chooseType(
          ...
          RichTextSelectionHandleType.left,
          RichTextSelectionHandleType.right,
        );
        break;
      case _TextSelectionHandlePosition.end:
  ...
  RichTextSelectionHandleType _chooseType(
    TextDirection textDirection,
    RichTextSelectionHandleType ltrType,
    RichTextSelectionHandleType rtlType,
  ) {
    if (widget.selection.isCollapsed) return RichTextSelectionHandleType.collapsed;
...
abstract class RichTextSelectionGestureDetectorBuilderDelegate {
  ...
  /// [RichTextSelectionGestureDetectorBuilder] will build a [TextSelectionGestureDetector].
...
/// [RichTextSelectionGestureDetectorBuilder] can change the behavior performed in
...
class RichTextSelectionGestureDetectorBuilder {
  ...
  void onForcePressStart(ForcePressDetails details) {
    ...
    if (delegate.selectionEnabled) {
      renderEditable.selectWordsInRange(
        ...
        cause: RichSelectionChangedCause.forcePress,
      );
    }
  }
  ...
  void onSecondaryTap() {
    if (delegate.selectionEnabled) {
      if (!_lastSecondaryTapWasOnSelection) {
        renderEditable.selectWord(cause: RichSelectionChangedCause.tap);
      }
  ...
  ///
  /// By default, it selects a word through [RichRenderEditable.selectWord] if
  ...
  void onDragSelectionStart(DragStartDetails details) {
    ...
    renderEditable.selectPositionAt(
      from: details.globalPosition,
      cause: RichSelectionChangedCause.drag,
    );
  }
...
class TextSelectionGestureDetector extends StatefulWidget {
  ...
  final RichDragSelectionUpdateCallback? onDragSelectionUpdate;
