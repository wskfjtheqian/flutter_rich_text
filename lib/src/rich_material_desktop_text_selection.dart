...
class _RichDesktopTextSelectionControls extends RichTextSelectionControls {
  ...
  Widget buildToolbar(
    ...
    return _RichDesktopTextSelectionControlsToolbar(
...
final RichTextSelectionControls richMaterialDesktopTextSelectionControls =
_RichDesktopTextSelectionControls();

// Generates the child that's passed into DesktopTextSelectionToolbar.
class _RichDesktopTextSelectionControlsToolbar extends StatefulWidget {
  const _RichDesktopTextSelectionControlsToolbar({
    Key? key,
  ...
  final List<RichTextSelectionPoint> endpoints;
  ...
  @override
  _RichDesktopTextSelectionControlsToolbarState createState() => _RichDesktopTextSelectionControlsToolbarState();
}

class _RichDesktopTextSelectionControlsToolbarState extends State<_RichDesktopTextSelectionControlsToolbar> {
  RichClipboardStatusNotifier? _clipboardStatus;
  ...
  void initState() {
    ...
    if (widget.handlePaste != null) {
      _clipboardStatus = widget.clipboardStatus ?? RichClipboardStatusNotifier();
  ...
  @override
  void didUpdateWidget(_RichDesktopTextSelectionControlsToolbar oldWidget) {
...
/// See also:
///
///  * [_RichDesktopTextSelectionControls.buildToolbar], where this is used by
