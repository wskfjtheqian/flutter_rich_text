...
class RichMaterialTextSelectionControls extends RichTextSelectionControls {
  ...
  @override
  Widget buildHandle(BuildContext context, RichTextSelectionHandleType type, double textHeight) {
    ...
    switch (type) {
      case RichTextSelectionHandleType.left: // points up-right
        return Transform.rotate(
          angle: math.pi / 2.0,
          child: handle,
        );
      case RichTextSelectionHandleType.right: // points up-left
        return handle;
      case RichTextSelectionHandleType.collapsed: // points up
        return Transform.rotate(
          angle: math.pi / 4.0,
          child: handle,
        );
  ...
  Offset getHandleAnchor(RichTextSelectionHandleType type, double textLineHeight) {
    switch (type) {
      case RichTextSelectionHandleType.left:
        return const Offset(_kHandleSize, 0);
      case RichTextSelectionHandleType.right:
        return Offset.zero;
      default:
...
class _TextSelectionControlsToolbarState extends State<_TextSelectionControlsToolbar> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final RichTextSelectionPoint startTextSelectionPoint = widget.endpoints[0];
    final RichTextSelectionPoint endTextSelectionPoint = widget.endpoints.length > 1
        ? widget.endpoints[1]
        : widget.endpoints[0];
...
final RichTextSelectionControls richMaterialTextSelectionControls = RichMaterialTextSelectionControls();
