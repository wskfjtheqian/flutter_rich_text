...
class RichCupertinoTextSelectionControls extends RichTextSelectionControls {
  ...
  Widget buildHandle(BuildContext context, RichTextSelectionHandleType type, double textLineHeight) {
    ...
    // iOS doesn't draw anything for collapsed selections.
      case RichTextSelectionHandleType.collapsed:
...
final RichTextSelectionControls richCupertinoTextSelectionControls = RichCupertinoTextSelectionControls();
